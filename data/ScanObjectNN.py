...
def download():
    BASE_DIR = ''  #this is our data url,must write in there,if you don't have ,just download() to download the datasets.
...
def load_scanobjectnn_data(partition):
    ...
    print(f'{partition} samples: {data.shape[0]}')  # 添加这行代码来打印样本数量
